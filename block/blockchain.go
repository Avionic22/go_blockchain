...
// Create block struct and functions
type Block struct {
	timestamp    int64
	nonce        int
...
// Create Blockchain struct and functions
...
func (bc *Blockchain) SetNeighbors() {
	bc.neighbors = utils.FindNeighbors(utils.GetHost(), bc.port, NEIGHBOR_IP_START, NEIGHBOR_IP_END, BLOCKCHAIN_PORT_RANGE_START, BLOCKCHAIN_PORT_RANGE_END)
...
// Validation and creation of block
...
// Create transaction struct and methods
